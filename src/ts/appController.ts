...
class RootViewModel {
  ...
  constructor() {
    ...
    const navData = [
      { path: "", redirect: "tree" },
      { path: "tree", detail: { label: "SNOMED Tree View", iconClass: "oj-ux-ico-bar-chart" } },
      { path: "textsearch", detail: { label: "SNOMED Search", iconClass: "oj-ux-ico-bar-chart" } },
    ...
    this.appName = ko.observable("SNOMED Tree Browser");
